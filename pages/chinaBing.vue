<template>
  <div class="deliciousTitle">
    <img src="/delicious/chinaBingBannerApp.png" alt="banner" class="lt-md" />
    <img src="/delicious/chinaBingBanner.png" alt="banner" class="gt-sm" />
  </div>
  <!-- 餐點 -->
