    ...
    <q-carousel
      ...
      <q-carousel-slide :name="2">
        <nuxt-link to="/chinaBing#bandong">
          <img src="/index/Banner02.png" alt="Banner2" class="gt-sm" />
          <img src="/index/Banner02App.jpg" alt="Banner2" class="lt-md" />
        </nuxt-link>
      </q-carousel-slide>
      <!-- 第3張輪播圖片 -->
      <q-carousel-slide :name="3">
        <nuxt-link to="/chinaBing#box">
...
const bannerSlide = ref(3)
const bannerAutoplay = ref(5000)
...
const section1Cards = ref<Card[]>([
  ...
  },
  {
    ...
    title: '米香油飯盒',
    description: '中華一全新品牌〈喜客油飯〉，用台灣古早味麻油米香油飯為基底主角，同時使用台灣在地食材與精選主餐，製作出獨具特色的「米香油飯餐盒」。',
    titleColor: 'orange-7',
    btnColor: 'orange-7',
    btnText: '查看米香油飯盒菜單',
    href: '/cico',
...
const section2Cards = ref<Card[]>([
  {
    imgSrc: '/delicious/dialog-2-pic-10.png',
    tagSrc: '/delicious/bingTag.png',
    title: '午茶盒餐',
  ...
  },
  {
    ...
    title: '豆花甜湯',
    description: '甜品是讓人開讓人感覺到快樂與幸福，讓花豆囍事用最美好的味蕾感受，讓你天都能Sweet ! Sweet !',
    titleColor: 'yellow-7',
    btnColor: 'grey',
    btnText: '盡請期待',
    // href: '/budget',
...
const section3Cards = ref<Card[]>([
  {
    ...
    tagSrc: '/delicious/bingTag.png',
    title: '午茶盒餐',
    description: '3吋潤餅 + 蜂蜜芥末醬地瓜 + 主廚小點 + 香滷雞翅 + 湯飲品選擇 1',
    titleColor: 'pink-8',
    btnColor: 'pink-8',
    tagText: 'Top1',
    btnText: '立即預訂',
...
const imagesToPreload = ['/index/Banner01.png', '/index/Banner02.png', '/index/Banner03.png', '/index/Banner04.png']
