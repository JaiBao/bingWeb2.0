...
const slides = ref([
  // {
  //   card: {
  //     image: '/delicious/guabao-lunchbox-7.png',
  //     title: '經濟盒餐',
  //     text: { main: '刈包', span: '(口味6擇1)', text2: '地瓜薯薯 + 湯飲品擇1' },
  //     price: 'NT$80'
  //   },
  //   dialog: {
  //     image: '/delicious/guabao-lunchbox-7.png',
  ...
  // {
  //   card: {
  //     image: '/delicious/guabao-lunchbox-share.png',
  //     title: '分享餐',
  //     text: {
  //       main: '3 吋潤餅 6 入',
  //       span: '(口味 6 擇 3 或 2)',
  ...
  //   },
  //   dialog: {
  //     image: '/delicious/dialog-guabao-lunchbox-share.jpg',
  //     title: '分享餐',
  //     text: {
  //       main: '3 吋潤餅 6 入',
  //       span: '(口味 6 擇 3 或 2)',
