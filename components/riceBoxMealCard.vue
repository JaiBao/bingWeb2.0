...
const slides = ref([
  {
    ...
    dialog: {
      ...
      image: '/delicious/2-pic-17.png',
      title: '控肉油飯盒',
      main_category_code: 'riceBox',
      price: 100,
      comment: '',
      text: {
        main: '香滷控肉',

        text2: '極品油飯+古早味筍絲+家鄉酸菜+滷蛋+杏鮑菇+香滷豆干 '
        // note: '湯飲品擇1'
      },
      listItems: [
        {
          ...
          name: '主餐',
          id: 1,
          product_option_id: 164, //主餐ID
          // span: '6擇1',
          items: [{ text: '香滷控肉油飯盒', name: '極品油飯', image: '/delicious/2-pic-17.png', product_option_value_id: 2233 }]
        },
        {
          title: '加購湯飲品',
          id: 2,
          product_option_id: 239, //飲料ID
          price: 15,
          name: '飲料',
          span: '+$15',
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 2234 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 2235 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 2236 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 2237 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 2239 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 2238 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          name: '主餐',
          id: 1,
          product_option_id: 188, //主餐ID
          // span: '6擇1',
          items: [{ text: '香滷雞翅油飯盒', name: '極品油飯', image: '/delicious/2-pic-18.png', product_option_value_id: 2228 }]
        },
        {
          title: '加購湯飲品',
          id: 2,
          ...
          items: [
            ...
            { text: '季節甜品', name: '甜湯', product_option_value_id: 1868 },
      ...
      listItems: [
        {
          ...
          name: '主餐',
          id: 1,
          product_option_id: 169, //主餐ID
          // span: '6擇1',
          items: [{ text: '香辣滷牛油飯盒', name: '極品油飯', image: '/delicious/2-pic-21.png', product_option_value_id: 1754 }]
        },
        {
          title: '加購湯飲品',
          id: 2,
          product_option_id: 170, //飲料ID
          price: 15,
          name: '飲料',
          span: '+$15',
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 1755 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 1756 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 1757 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 1758 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 1760 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 1759 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          name: '主餐',
          id: 1,
          product_option_id: 167, //主餐ID
          // span: '6擇1',
          items: [{ text: '香滷雞腿油飯盒', name: '極品油飯', image: '/delicious/2-pic-22.png', product_option_value_id: 1747 }]
        },
        {
          title: '加購湯飲品',
          id: 2,
          product_option_id: 168, //飲料ID
          price: 15,
          name: '飲料',
          span: '+$15',
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 1748 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 1749 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 1750 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 1751 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 1753 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 1752 }
          ]
        }
      ]
    }
