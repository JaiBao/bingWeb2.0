...
const slides = ref([
      ...
      listItems: [
        {
          ...
          items: [
            ...
            { text: '薯泥香素鬆潤餅', note: '蛋奶素', name: '薯泥潤餅3吋', image: '/delicious/2-pic-11.png', product_option_value_id: 1 },
            { text: '千島香酥蝦潤餅', name: '炸蝦潤餅3吋', image: '/delicious/2-pic-12.png', product_option_value_id: 2 },
            { text: '蜂蜜芥末雞潤餅', note: '微辣', name: '炒雞潤餅3吋', image: '/delicious/2-pic-13.png', product_option_value_id: 3 },
            { text: '蒜味鄉村魚潤餅', name: '酥魚潤餅3吋', image: '/delicious/2-pic-14.png', product_option_value_id: 4 },
            { text: '凱薩烤培根潤餅', name: '培根潤餅3吋', image: '/delicious/2-pic-15.png', product_option_value_id: 5 },
            { text: '媽手老滷肉潤餅', note: '預訂供應', name: '滷肉潤餅3吋', image: '/delicious/2-pic-16.png', product_option_value_id: 6 }
          ]
        },
        {
          title: '加購湯飲品',
          ...
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 7 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 8 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 9 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 10 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 12 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 11 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          items: [
            ...
            { text: '素食潤餅便當', name: '蛋素潤餅3吋', image: '/delicious/2-pic-5.png', product_option_value_id: 1848 }
          ]
        },
        {
          title: '加購湯飲品',
          ...
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 1850 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 1851 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 1852 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 1853 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 1855 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 1854 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          items: [
            ...
            { text: '薯泥香素鬆潤餅', note: '蛋奶素', name: '薯泥潤餅3吋', image: '/delicious/2-pic-11.png', product_option_value_id: 21 },
            { text: '千島香酥蝦潤餅', name: '炸蝦潤餅3吋', image: '/delicious/2-pic-12.png', product_option_value_id: 22 },
            { text: '蜂蜜芥末雞潤餅', note: '微辣', name: '炒雞潤餅3吋', image: '/delicious/2-pic-13.png', product_option_value_id: 23 },
            { text: '蒜味鄉村魚潤餅', name: '酥魚潤餅3吋', image: '/delicious/2-pic-14.png', product_option_value_id: 24 },
            { text: '凱薩烤培根潤餅', name: '培根潤餅3吋', image: '/delicious/2-pic-15.png', product_option_value_id: 25 },
            { text: '媽手老滷肉潤餅', note: '預訂供應', name: '滷肉潤餅3吋', image: '/delicious/2-pic-16.png', product_option_value_id: 26 }
          ]
        },
        {
          title: '加購湯飲品',
          ...
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 27 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 28 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 29 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 30 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 32 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 31 }
          ]
        }
      ]
    }
  ...
  //           { text: '季節甜品', name: '甜湯', product_option_value_id: 592 },
      ...
      listItems: [
        {
          ...
          items: [
            ...
            { text: '薯泥香素鬆潤餅', note: '蛋奶素', name: '薯泥潤餅3吋', image: '/delicious/2-pic-11.png', product_option_value_id: 42 },
            { text: '千島香酥蝦潤餅', name: '炸蝦潤餅3吋', image: '/delicious/2-pic-12.png', product_option_value_id: 43 },
            { text: '蜂蜜芥末雞潤餅', note: '微辣', name: '炒雞潤餅3吋', image: '/delicious/2-pic-13.png', product_option_value_id: 44 },
            { text: '蒜味鄉村魚潤餅', name: '酥魚潤餅3吋', image: '/delicious/2-pic-14.png', product_option_value_id: 45 },
            { text: '凱薩烤培根潤餅', name: '培根潤餅3吋', image: '/delicious/2-pic-15.png', product_option_value_id: 46 },
            { text: '媽手老滷肉潤餅', note: '預訂供應', name: '滷肉潤餅3吋', image: '/delicious/2-pic-16.png', product_option_value_id: 47 }
          ]
        },
        {
          title: '加購湯飲品',
          ...
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 48 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 49 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 50 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 51 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 53 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 52 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          items: [
            ...
            { text: '薯泥香素鬆潤餅', note: '蛋奶素', name: '薯泥潤餅3吋', image: '/delicious/2-pic-11.png', product_option_value_id: 63 },
            { text: '千島香酥蝦潤餅', name: '炸蝦潤餅3吋', image: '/delicious/2-pic-12.png', product_option_value_id: 64 },
            { text: '蜂蜜芥末雞潤餅', note: '微辣', name: '炒雞潤餅3吋', image: '/delicious/2-pic-13.png', product_option_value_id: 65 },
            { text: '蒜味鄉村魚潤餅', name: '酥魚潤餅3吋', image: '/delicious/2-pic-14.png', product_option_value_id: 66 },
            { text: '凱薩烤培根潤餅', name: '培根潤餅3吋', image: '/delicious/2-pic-15.png', product_option_value_id: 67 },
            { text: '媽手老滷肉潤餅', note: '預訂供應', name: '滷肉潤餅3吋', image: '/delicious/2-pic-16.png', product_option_value_id: 68 }
          ]
        },
        {
          title: '加購湯飲品',
          ...
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 69 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 70 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 71 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 72 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 74 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 73 }
          ]
        }
      ]
    }
  ...
  //           { text: '季節甜品', name: '甜湯', product_option_value_id: 607 },
      ...
      listItems: [
        {
          ...
          items: [
            ...
            { text: '薯泥香素鬆潤餅', note: '蛋奶素', name: '薯泥潤餅3吋', image: '/delicious/2-pic-11.png', product_option_value_id: 785 },
            { text: '千島香酥蝦潤餅', name: '炸蝦潤餅3吋', image: '/delicious/2-pic-12.png', product_option_value_id: 780 },
            { text: '蜂蜜芥末雞潤餅', note: '微辣', name: '炒雞潤餅3吋', image: '/delicious/2-pic-13.png', product_option_value_id: 781 },
            { text: '蒜味鄉村魚潤餅', name: '酥魚潤餅3吋', image: '/delicious/2-pic-14.png', product_option_value_id: 782 },
            { text: '凱薩烤培根潤餅', name: '培根潤餅3吋', image: '/delicious/2-pic-15.png', product_option_value_id: 783 },
            { text: '媽手老滷肉潤餅', note: '預訂供應', name: '滷肉潤餅3吋', image: '/delicious/2-pic-16.png', product_option_value_id: 784 }
          ]
        },
        {
          title: '加購湯飲品',
          ...
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 788 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 789 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 790 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 791 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 793 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 792 }
          ]
        }
      ]
    }
      ...
      listItems: [
        {
          ...
          items: [
            ...
            { text: '薯泥香素鬆潤餅', note: '蛋奶素', name: '薯泥潤餅3吋', image: '/delicious/2-pic-11.png', product_option_value_id: 1803 },
            { text: '千島香酥蝦潤餅', name: '炸蝦潤餅3吋', image: '/delicious/2-pic-12.png', product_option_value_id: 1804 },
            { text: '蜂蜜芥末雞潤餅', note: '微辣', name: '炒雞潤餅3吋', image: '/delicious/2-pic-13.png', product_option_value_id: 1805 },
            { text: '蒜味鄉村魚潤餅', name: '酥魚潤餅3吋', image: '/delicious/2-pic-14.png', product_option_value_id: 1806 },
            { text: '凱薩烤培根潤餅', name: '培根潤餅3吋', image: '/delicious/2-pic-15.png', product_option_value_id: 1807 },
            { text: '媽手老滷肉潤餅', note: '預訂供應', name: '滷肉潤餅3吋', image: '/delicious/2-pic-16.png', product_option_value_id: 1808 }
          ]
        },
        {
          title: '加購湯飲品',
          ...
          // 沒有備註的項目可以只有text字段
          items: [
            { text: '微甜豆漿', name: '微豆', product_option_value_id: 1811 },
            { text: '無糖豆漿', name: '無豆', product_option_value_id: 1812 },
            { text: '古早味紅茶', name: '紅茶', product_option_value_id: 1813 },
            { text: '古早味奶茶', name: '奶茶', product_option_value_id: 1814 },
            { text: '季節甜品', name: '甜湯', product_option_value_id: 1816 },
            { text: '季節濃湯', note: '', name: '濃湯', product_option_value_id: 1815 }
          ]
        }
      ]
    }
